class Car:
    wheels = 4
    # 아래에 코드를 작성하시오.
    def __init__(self, type_of_engine, driving_system, sound):
    ...
    def drive(self):
        print(self.sound)
        return self.type_of_engine
    
    def introduce(self):
        print(f'제 차의 엔진은 {self.type_of_engine} 방식이고, {self.driving_system}(으)로 동작합니다.')
